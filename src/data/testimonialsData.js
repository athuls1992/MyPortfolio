...
export const testimonialsData = [
    {
        ...
        name: 'Mujtaba',
        title: 'Google PPCier',
        text: "Athul is a true full stack developer and I always reach out to him for the most complex problems...",
        image: boy2
    },
    {
        id: 2,
        name: 'Richard Luna',
        title: 'ProtectedHarbor- Client of Athul',
        text: "Athul is a hard worker and a good programmer. His specialty was communicating with the end users..",
        image: boy3
    },
    {
        id: 3,
        name: 'Zeehan Akthar',
        title: 'Business Analyst - Emirates NBD',
        text: "Athul firstly is a wonderful person. His calm, hardworking and helpful attitude spreads positivity on the work floor..",
        image: boy1
    }
    // {
    //     id: 4,
